                ...
                <div className="mid mb-5">
                    ...
                    <div className=" bg-purple-50 py-5 rounded-xl border border-purple-100">
                        ...
                        <div className="flex justify-center ">
                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSNfdNAymDbGvOq5TBq0w25_R34aFTZYDShIw&s" alt="" />
                        </div>
                        {/* text  */}
                           <div className="">
                            {/* Name  */}
                    ...
                    <Tabs>
                        <TabList className="flex flex-wrap -m-4 text-center justify-center">
                            ...
                            <Tab className="p-4 md:w-1/3 sm:w-1/2 w-full cursor-pointer">
                                <div className=" border bg-purple-50 hover:bg-purple-100 border-purple-100 px-10 py-3 rounded-xl" >
