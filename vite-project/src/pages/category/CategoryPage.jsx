                                        ...
                                        <div className="p-6">
                                            ...
                                            <div
                                                ...
                                                <button
                                                    ...
                                                    className=" bg-purple-400 border border--600  hover:bg-purple-600 w-full text-white py-[4px] rounded-lg font-bold">
                                                    Delete To Cart
                                                </button>
                                                ...
                                                <button
                                                    ...
                                                    className=" bg-pink-600 border border-pink-600  hover:bg-pink-200 w-full text-white py-[4px] rounded-lg font-bold">
                                                    Add To Cart
                                                </button>
                                            }
                                            </div>
